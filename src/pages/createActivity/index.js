        ...
        return currentDate.getTime() < selectedDate.getTime();
          ...
          const create_activity=(e)=>{
            ...
            const data= ({
              ...
              summary:summary,
              products: file,
              duration:[{'start_time':startDate, 'end_time':secondOption}],
        })
    ...
    <Card className='w-100 jet my-auto mx-auto p-5'>
     ...
     <Form
          ...
          >
                ...
                <Form.Group  as={Row}>
                    ...
                    <form>
                        <div>
                          ...
                          {file&&file.product1&&       <Form.Control
                              name="product1_price"
                              type="number"
                              inputmode="tel"
                              required
                    ...
                    <form>
                        <div>
                          ...
                          {file&&file.product2&&       <Form.Control
                  name="product2_price"
                  type="number"
                  inputmode="tel"
                  required
                ...
                />}
                    ...
                    <form>
                        <div>
                          ...
                          {file&&file.product3&&       <Form.Control
                  name="product3_price"
                  type="number"
                  inputmode="tel"
            ...
            <div className='createActivityRow'>
            <Form.Label className="notes">
              <input type='checkbox' onChange={(e)=>setSummaryStatus(e.target.checked)} name='summarystatus' className='mr-2'/>
                  Summary of Activity
                </Form.Label>
                 <MyEditor
                    handleChange={(data) => {
